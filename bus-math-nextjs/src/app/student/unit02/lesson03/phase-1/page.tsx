...
if (!videoComponent) {
  throw new Error("Unit 2 Lesson 3 Phase 1 scenario is missing a video component.")
}

const comprehensionComponent = getPhaseComponent(phaseScenario, "comprehensionCheck")
if (!comprehensionComponent) {
  throw new Error("Unit 2 Lesson 3 Phase 1 scenario is missing a comprehension check component.")
}
...
export default function Unit02Lesson03Phase1() {
        ...
        <section className="space-y-6">
          ...
          <div className="max-w-4xl mx-auto space-y-8">
            ...
            <ComprehensionCheck
              ...
              title={comprehensionData.title ?? "Understanding Timing Differences"}
              description={
                comprehensionData.description ??
                "Test your understanding of why timing matters in accrual accounting."
              }
