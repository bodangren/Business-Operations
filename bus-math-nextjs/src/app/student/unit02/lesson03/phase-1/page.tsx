...
if (!comprehensionComponent) {
  throw new Error("Unit 02 Lesson 03 Phase 1 scenario is missing a comprehension check component.")
}
            ...
            <Card className="border-yellow-200 bg-white shadow-sm">
              <CardHeader>
                <CardTitle className="text-yellow-800">
                  {comprehensionData.title ?? "Automation Blueprint Recall"}
                </CardTitle>
              </CardHeader>
              <CardContent>
                <ComprehensionCheck
                  ...
                  description={
                    comprehensionData.description ??
                      "Make sure you can describe why Sarah needs perfect timing logic before she automates anything."
                  }
