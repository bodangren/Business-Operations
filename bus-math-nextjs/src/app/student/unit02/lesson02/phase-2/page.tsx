...
if (!comprehensionComponent) {
  throw new Error("Unit 02 Lesson 02 Phase 2 scenario is missing a comprehension check component.")
}

const fillInBlankComponent = getPhaseComponent(phaseScenario, "fillInTheBlank")
if (!fillInBlankComponent) {
  throw new Error("Unit 02 Lesson 02 Phase 2 scenario is missing a fill-in-the-blank component.")
}
            ...
            <Card className="border-blue-200 bg-white shadow-sm">
              <CardHeader>
                <CardTitle className="text-blue-800">
                  {comprehensionData.title ?? "Adjusting Entry Knowledge Check"}
                </CardTitle>
              </CardHeader>
              <CardContent>
                <ComprehensionCheck
                  ...
                  description={
                    comprehensionData.description ??
                      "Confirm that you can summarize the four timing rules that power the Month-End Wizard."
                  }
            ...
            <Card className="border-purple-200 bg-purple-50 dark:bg-purple-950/10">
              ...
              <CardContent>
                <FillInTheBlank
                  ...
                  description="Reinforce key vocabulary for accruals, deferrals, depreciation, and closing entries."
                />
              </CardContent>
            </Card>
          </div>
