...
if (!comprehensionComponent) {
  throw new Error("Unit 2 Lesson 2 Phase 5 scenario is missing a comprehension check component.")
}

const fillInBlankComponent = getPhaseComponent(phaseScenario, "fillInTheBlank")
if (!fillInBlankComponent) {
  throw new Error("Unit 2 Lesson 2 Phase 5 scenario is missing a fill in the blank component.")
}
        ...
        <section className="space-y-6">
          ...
          <div className="max-w-4xl mx-auto space-y-8">
            ...
            <ComprehensionCheck
              ...
              title={comprehensionData.title ?? "Adjusting Entries Mastery Assessment"}
              description={
                comprehensionData.description ??
                "Demonstrate your understanding of adjusting entries and their impact on financial statements."
              }
            ...
            <Card className="border-green-200 shadow-lg">
              <CardContent className="p-6">
                <FillInTheBlank
                  ...
                  description="Complete these important scenarios about adjusting entries"
