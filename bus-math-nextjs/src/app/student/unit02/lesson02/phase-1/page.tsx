...
if (!comprehensionComponent) {
  throw new Error("Unit 02 Lesson 02 Phase 1 scenario is missing a comprehension check component.")
}
            ...
            <Card className="border-emerald-200 bg-white shadow-sm">
              <CardHeader>
                <CardTitle className="text-emerald-800">
                  {comprehensionData.title ?? "Understanding the Pressure"}
                </CardTitle>
              </CardHeader>
              <CardContent>
                <ComprehensionCheck
                  ...
                  description={
                    comprehensionData.description ??
                      "Test your recall of the timing breakdowns that pushed Sarah toward automation."
                  }
