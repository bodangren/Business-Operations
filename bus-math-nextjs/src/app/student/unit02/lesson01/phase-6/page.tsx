...
if (!reflectionComponent) {
  throw new Error("Unit 02 Lesson 01 Phase 6 scenario is missing a reflection component.")
}
        ...
        <section className="space-y-6">
          ...
          <div className="max-w-4xl mx-auto space-y-8">
            ...
            <Card className="border-amber-200 bg-white shadow-sm">
              <CardHeader>
                <CardTitle className="text-amber-800">{reflectionData.title}</CardTitle>
              </CardHeader>
              <CardContent className="space-y-4">
                {reflectionData.journalingFocus && (
                  <p className="text-amber-900/80">{reflectionData.journalingFocus}</p>
                )}
                <ReflectionJournal
