...
if (!comprehensionComponent) {
  throw new Error("Unit 2 Lesson 1 Phase 2 scenario is missing a comprehension check component.")
}

const fillInBlankComponent = getPhaseComponent(phaseScenario, "fillInTheBlank")
if (!fillInBlankComponent) {
  throw new Error("Unit 2 Lesson 1 Phase 2 scenario is missing a fill in the blank component.")
}
        ...
        <section className="space-y-6">
          ...
          <div className="max-w-4xl mx-auto space-y-8">
            ...
            <ComprehensionCheck
              ...
              title={comprehensionData.title ?? "From Manual Chaos to Structured Automation"}
              description={
                comprehensionData.description ??
                "Check your understanding of why automation matters now for Sarah's business."
              }
