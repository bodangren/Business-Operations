...
if (!comprehensionComponent) {
  throw new Error("Unit 2 Lesson 1 Phase 3 scenario is missing a comprehension check component.")
}
        ...
        <section className="space-y-6">
          ...
          <div className="max-w-4xl mx-auto space-y-8">
            ...
            <ComprehensionCheck
              ...
              title={comprehensionData.title ?? "Journal Entry Logic Check"}
              description={
                comprehensionData.description ??
                "Confirm your understanding of the four month-end scenarios you will automate later in the unit."
              }
