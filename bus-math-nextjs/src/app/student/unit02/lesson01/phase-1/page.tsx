...
if (!videoComponent) {
  throw new Error("Unit 2 Lesson 1 Phase 1 scenario is missing a video component.")
}

const comprehensionComponent = getPhaseComponent(phaseScenario, "comprehensionCheck")
if (!comprehensionComponent) {
  throw new Error("Unit 2 Lesson 1 Phase 1 scenario is missing a comprehension check component.")
}
          ...
          <div className="max-w-4xl mx-auto space-y-8">
            ...
            <ComprehensionCheck
              ...
              description={
                ...
                "Check your grasp of the stakes behind TechStart's month-end automation journey."
              }
