...
if (!comprehensionComponent) {
  throw new Error("Unit 2 Lesson 1 Phase 4 scenario is missing a comprehension check component.")
}
        ...
        <section className="space-y-6">
          ...
          <div className="max-w-4xl mx-auto space-y-8">
            ...
            <ComprehensionCheck
              ...
              title={comprehensionData.title ?? "Independent Automation Analysis Assessment"}
              description={
                comprehensionData.description ??
                "Apply your analytical skills to evaluate automation opportunities and business impact."
              }
