import { unit03Data } from "../lesson01/lesson-data"

export const practiceTestLessonData = {
  id: "unit03-practice-test",
  title: "Unit 3 Practice Test: Three-Statement Mastery",
  sequence: 11,
  unitId: unit03Data.id
}

export const practiceTestPhases = [
  {
    id: "unit03-practice-test-phase-1",
    phaseName: "Hook" as const,
    sequence: 1,
    description: "Set the scene for Sarah's investor presentation and preview how this practice test keeps your three-statement integration sharp."
  },
  {
    id: "unit03-practice-test-phase-2",
  ...
  {
    id: "unit03-practice-test-phase-3",
  ...
  {
    id: "unit03-practice-test-phase-4",
