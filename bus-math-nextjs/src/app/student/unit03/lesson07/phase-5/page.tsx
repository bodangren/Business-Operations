...
const auditMiniQuiz = [
  ...
  {
    id: "u3l7-audit-2",
    question: "Which message is clearer for users when a lookup fails?",
    answers: [
      "IFNA returns 'Scenario not found — check name'",
            ...
            <div className="max-w-4xl mx-auto space-y-8 text-left">
              <Card className="border-yellow-200 bg-white">
                ...
                <CardContent className="text-yellow-900">
                  <p className="mb-2">Investor‑ready means:</p>
                  <ul className="list-disc list-inside space-y-1">
                    <li>Clarity: One‑screen summary with readable visuals</li>
                    <li>Reliability: Exact references, validations, and reconciliation tie‑outs</li>
                    <li>Audit trail: Assumptions documented; formulas transparent</li>
                    <li>Decisions: Executive summary states risks, thresholds, and a recommendation</li>
                  </ul>
                </CardContent>
              </Card>
              ...
              <Card className="border-emerald-200 bg-white">
                ...
                <CardContent>
                  ...
                  <PeerCritiqueForm projectTitle="Unit 03 Investor Dashboard" peerName="Partner" unitNumber={3} />
                </CardContent>
              </Card>

              <div className="text-sm text-gray-600">
                Career tie: This mirrors an analyst/consultant workflow — build → validate → insights → recommend.
              </div>
            </div>
          </div>
        </section>
