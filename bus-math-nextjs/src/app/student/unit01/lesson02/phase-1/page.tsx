...
if (!comprehensionComponent) {
  throw new Error("Unit 01 Lesson 02 Phase 1 scenario is missing a comprehension check component.")
}
      ...
      <main className="container mx-auto px-4 py-8 space-y-8">
        <section className="space-y-6">
          ...
          <div className="max-w-4xl mx-auto space-y-8">
            ...
            <Card className="border-rose-200 bg-rose-50 dark:bg-rose-950/10">
              <CardHeader>
                <CardTitle className="text-rose-800">
                  {comprehensionData.title ?? "Engagement Check: Understanding Business Balance"}
                </CardTitle>
              </CardHeader>
              <CardContent>
                <ComprehensionCheck
                  ...
                  description={
                    ...
                    "Test your understanding of Sarah's balance challenge and why investors care about clean books."
                  }
