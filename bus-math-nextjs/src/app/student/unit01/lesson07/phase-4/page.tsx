              ...
              <Card className="border-orange-200 bg-white">
                ...
                <CardContent>
                  <p className="text-orange-900 mb-3">
                    ...
                    ledger and ensure your validations and reconciliations handle each case.
                  </p>
                  <a className="text-blue-700 underline font-medium" href="/resources/unit01-ledger-lesson07-practice.csv" download>
                    /resources/unit01-ledger-lesson07-practice.csv
                  </a>
                  <div className="mt-4 text-sm text-gray-700">
                    Includes: invalid scenario names, stale dates, rounding near thresholds, negative/invalid amounts,
                    and unbalanced entries for reconciliation.
                  </div>
                </CardContent>
              </Card>
