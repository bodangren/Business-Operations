...
if (!comprehensionComponent) {
  throw new Error("Unit 01 Lesson 04 Phase 5 scenario is missing a comprehension check component.")
}
            ...
            <Card className="border-orange-200 bg-orange-50 dark:bg-orange-950/10">
              <CardHeader>
                <CardTitle className="text-orange-800">
                  {comprehensionData.title ?? "Excel Tables & SUMIF Mastery"}
                </CardTitle>
              </CardHeader>
              <CardContent>
                <ComprehensionCheck
                  ...
                  description={
                    ...
                    "Ten questions covering technical ability and investor-ready automation reasoning."
                  }
