...
if (!comprehensionComponent) {
  throw new Error("Unit 01 Lesson 04 Phase 1 scenario is missing a comprehension check component.")
}
            ...
            <Card className="border-red-200 bg-red-50 dark:bg-red-950/10">
              <CardHeader>
                <CardTitle className="text-red-800">
                  {comprehensionData.title ?? "Automation Mindset Check"}
                </CardTitle>
              </CardHeader>
              <CardContent>
                <ComprehensionCheck
                  ...
                  description={comprehensionData.description}
