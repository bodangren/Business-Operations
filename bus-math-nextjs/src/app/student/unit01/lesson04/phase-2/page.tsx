...
if (!comprehensionComponent) {
  throw new Error("Unit 01 Lesson 04 Phase 2 scenario is missing a comprehension check component.")
}

const fillInTheBlankComponent = getPhaseComponent(phaseScenario, "fillInTheBlank")
if (!fillInTheBlankComponent) {
  throw new Error("Unit 01 Lesson 04 Phase 2 scenario is missing a fill-in-the-blank component.")
}
            ...
            <Card className="border-blue-200 bg-blue-50 dark:bg-blue-950/10">
              <CardHeader>
                <CardTitle className="text-blue-800">
                  {comprehensionData.title ?? "Excel Table + SUMIF Concepts"}
                </CardTitle>
              </CardHeader>
              <CardContent>
                <ComprehensionCheck
                  ...
                  description={
                    ...
                    "Check your understanding of why Excel Tables and SUMIF unlock professional automation."
                  }
            ...
            <Card className="border-amber-200 bg-amber-50 dark:bg-amber-950/10">
              ...
              <CardContent>
                <FillInTheBlank
                  ...
                  description="Fill in the automation vocabulary so structured references and SUMIF feel natural."
                  showHints={true}
                />
              </CardContent>
            </Card>
