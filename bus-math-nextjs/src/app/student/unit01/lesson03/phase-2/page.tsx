...
if (!fillInTheBlankComponent) {
  throw new Error("Unit 01 Lesson 03 Phase 2 scenario is missing a fill-in-the-blank component.")
}
        ...
        <section className="space-y-6">
          ...
          <div className="max-w-4xl mx-auto space-y-8">
            ...
            <Card className="border-blue-200 bg-blue-50 dark:bg-blue-950/10">
              <CardHeader>
                <CardTitle className="text-blue-800">{fillInTheBlankData.title}</CardTitle>
              </CardHeader>
              <CardContent>
                <FillInTheBlank
                  sentences={fillInTheBlankData.sentences}
                  title={fillInTheBlankData.title}
                  description="Complete the DEA LER vocabulary to lock in the debit and credit rules."
                  showHints={true}
                />
              </CardContent>
            </Card>
