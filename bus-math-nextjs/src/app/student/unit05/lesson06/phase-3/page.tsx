      ...
      <main className="container mx-auto px-4 py-8 space-y-8">
        <section className="space-y-6">
          <div className="text-center space-y-4">
            ...
            <h1 className="text-3xl font-bold text-gray-900">Build Sarah’s Payroll Integration Dashboard</h1>
            <p className="text-lg text-gray-700 max-w-4xl mx-auto leading-relaxed">
              Implement scenario controls with a driver table, link outputs to visuals, and install validation that
              catches missing IDs, stale dates, and out‑of‑range rates.
            </p>
          </div>
        </section>
          ...
          <Card className="border-purple-200 bg-purple-50">
            ...
            <CardContent className="text-purple-900 space-y-2">
              <ul className="list-disc list-inside text-sm space-y-1">
                <li>No hard‑coded totals; all outputs driven by inputs.</li>
                ...
                <li>Audit panel counts: missing employee IDs, stale AsOfDate, rate bounds (0–100%).</li>
          ...
          <Card>
            ...
            <CardContent>
              <p className="text-sm text-gray-700 mb-3">
                Use the validation tool to practice rules like “Scenario name must not be blank,” “Hours ≥ 0,” “Rates
                between 0% and 100%,” and “AsOfDate within 30 days.” Transfer these patterns into your spreadsheet model.
              </p>
              <ErrorCheckingSystem />
            </CardContent>
          </Card>
