...
const vocabSentences = [
  {
    ...
    hint: "Like Inventory[Units] instead of A2:A100"
  },
  {
    id: "2",
  ...
  {
    id: "3",
    text: "Wrap lookups with {blank}(…, \"SKU not found — check name\").",
    answer: "IFNA",
  ...
  {
    id: "5",
    text: "A professional model includes visible {blank}: stale dates, missing keys, negatives where invalid.",
    answer: "validation",
              ...
              <Card className="border-emerald-200 bg-white">
                ...
                <CardContent className="text-emerald-900">
                  <ul className="list-disc list-inside space-y-1">
                    ...
                    <li>Lookups: XLOOKUP or INDEX/MATCH (exact) + IFNA/IFERROR with clear text.</li>
                    <li>Tables: Structured refs (e.g., Inventory[Units]) so ranges auto‑expand.</li>
                    ...
                    <li>Reconciliation: Tie‑outs pass (inventory ledger ↔ financial statements, totals, balance checks).</li>
