...
import { Plus, Edit, Trash2, Save, X, BookOpen, TrendingUp, AlertCircle, HelpCircle, ChevronDown, ChevronUp } from 'lucide-react'
          ...
          <CardContent className="space-y-6">
            ...
            <div>
              ...
              <p className="text-blue-700">
                Master the fundamentals of double-entry bookkeeping by recording and validating business transactions 
                for your chosen startup type. Build a self-auditing ledger system that demonstrates "clean books" 
                for potential angel investors in Unit 1: Smart Ledger Launch.
              </p>
            </div>
