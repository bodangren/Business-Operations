/**
 * InterestCalculationBuilder Component
 * 
 * DEVELOPER USAGE:
 * ================
 ...
 * No props are required - it initializes with default payroll and cash flow scenarios.
 * 
 * STUDENT INTERACTION & LEARNING OBJECTIVES:
 * ==========================================
 * 
 * OBJECTIVE: Students learn to calculate different types of interest for business cash flow management,
 * specifically focusing on Unit 5's PayDay Simulator theme where businesses must predict payroll
 * cash-outs and manage financing needs.
 * 
 * HOW STUDENTS INTERACT:
 * 1. **Interactive Calculator Interface**: Students select from common business scenarios:
 *    - Short-term business loans for payroll coverage
 *    - Invoice factoring for immediate cash flow
 *    - Equipment financing with monthly payments
 *    - Credit line interest for operational expenses
 * 
 * 2. **Multiple Interest Types**: The interface teaches four key calculation types:
 *    - Simple Interest: Basic loan calculations for short-term financing
 *    - Compound Interest: Long-term financing and investment planning
 *    - Annuity Payments: Monthly loan payments and equipment financing
 *    - Present Value: Evaluating future cash flows and investment decisions
 * 
 * 3. **Real-World Payroll Context**: Each scenario connects to payroll timing challenges:
 *    - "Need $15,000 loan for 30 days to cover payroll before invoice collection"
 *    - "Equipment loan of $25,000 at 6.5% for new POS system to improve efficiency"
 *    - "Factor invoices worth $12,000 to get immediate cash at 3% monthly rate"
 * 
 * 4. **Excel Integration**: Students see the actual Excel formulas (PMT, PV, FV, RATE)
 *    and learn to use Excel's financial functions for accurate calculations.
 * 
 * 5. **Step-by-Step Building**: Interactive formula builder that shows:
 *    - Variable identification (Principal, Rate, Time, Payment)
 *    - Formula selection based on scenario type
 *    - Calculation execution with safety validation
 *    - Business interpretation of results
 * 
 * 6. **Safety Features**: Uses SafeFormulaEvaluator to prevent code injection
 *    while allowing students to experiment with different values safely.
 * 
 * EDUCATIONAL VALUE:
 * ==================
 * - Builds mathematical foundations for business finance and cash flow management
 * - Prepares students for Excel's financial functions and loan analysis
 * - Connects interest calculations to real payroll timing challenges
 * - Supports advanced financial modeling skills needed for startup business plans
 * - Demonstrates time value of money concepts essential for business decision making
 */
    ...
    <div className="w-full max-w-7xl mx-auto p-6 space-y-8">
      ...
      <div className="text-center space-y-4">
        ...
        <p className="text-lg text-gray-600 max-w-4xl mx-auto">
          ...
          for Unit 5's PayDay Simulator - where timing payroll with cash flow is critical for business success.
        </p>
          ...
          <div className="flex items-start gap-3">
            ...
            <div>
              ...
              <p className="text-yellow-700 mb-3">
                These interest calculations are essential for Unit 5's PayDay Simulator, where students learn to:
              </p>
