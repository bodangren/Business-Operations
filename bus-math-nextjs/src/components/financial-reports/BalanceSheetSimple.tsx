...
import { TrendingUp, TrendingDown, Scale, Download, AlertCircle } from 'lucide-react'
...
interface BalanceSheetSimpleProps {
...
export function BalanceSheetSimple({ 
  ...
  const defaultData: BalanceSheetData = {
    ...
    assets: {
      currentAssets: {
        ...
        inventory: 25000,
        prepaidExpenses: 3500,
        totalCurrentAssets: 84750
      },
      fixedAssets: {
        equipment: 45000,
    ...
    liabilities: {
      currentLiabilities: {
        ...
        accruedLiabilities: 4200,
        shortTermDebt: 8000,
        totalCurrentLiabilities: 24700
      },
      longTermLiabilities: {
        longTermDebt: 45000,
        mortgagePayable: 65000,
        totalLongTermLiabilities: 110000
      },
      totalLiabilities: 134700
    },
    equity: {
      commonStock: 50000,
      retainedEarnings: 40050,
      totalEquity: 90050
    },
    totalLiabilitiesAndEquity: 224750
  }
  ...
  const LineItem = ({ label, amount, isSubtotal = false, isTotal = false, indent = false, negative = false }: {
    label: string
    amount: number
    isSubtotal?: boolean
    isTotal?: boolean
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
          ...
          <div className="bg-blue-50 p-6 rounded-lg">
            ...
            <div className="mb-6">
              ...
              <LineItem label="Cash and Cash Equivalents" amount={statementData.assets.currentAssets.cash} indent />
              <LineItem label="Accounts Receivable" amount={statementData.assets.currentAssets.accountsReceivable} indent />
              <LineItem label="Inventory" amount={statementData.assets.currentAssets.inventory} indent />
              <LineItem label="Prepaid Expenses" amount={statementData.assets.currentAssets.prepaidExpenses} indent />
            ...
            <div className="mb-6">
              ...
              <LineItem label="Less: Accumulated Depreciation" amount={statementData.assets.fixedAssets.accumulatedDepreciation} indent negative />
              <LineItem label="Net Equipment" amount={statementData.assets.fixedAssets.netEquipment} indent />
              ...
              <LineItem label="Total Fixed Assets" amount={statementData.assets.fixedAssets.totalFixedAssets} isSubtotal />
            </div>
          ...
          <div className="space-y-6">
            ...
            <div className="bg-red-50 p-6 rounded-lg">
              ...
              <div className="mb-6">
                ...
                <LineItem label="Accounts Payable" amount={statementData.liabilities.currentLiabilities.accountsPayable} indent />
                <LineItem label="Accrued Liabilities" amount={statementData.liabilities.currentLiabilities.accruedLiabilities} indent />
                <LineItem label="Short-term Debt" amount={statementData.liabilities.currentLiabilities.shortTermDebt} indent />
              ...
              <div className="mb-6">
                ...
                <LineItem label="Long-term Debt" amount={statementData.liabilities.longTermLiabilities.longTermDebt} indent />
                <LineItem label="Mortgage Payable" amount={statementData.liabilities.longTermLiabilities.mortgagePayable} indent />
          ...
          <div className="mt-6 p-4 bg-yellow-50 rounded-lg border border-yellow-200">
            ...
            {!isBalanced && (
              <div className="text-center text-red-600 text-sm mt-2 font-semibold">
                ⚠️ Balance Sheet does not balance! Difference: {formatCurrency(Math.abs(statementData.assets.totalAssets - statementData.totalLiabilitiesAndEquity))}
              </div>
            )}
          </div>
        )}
