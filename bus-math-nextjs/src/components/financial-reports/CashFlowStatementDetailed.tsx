...
interface CashFlowStatementDetailedProps {
...
export function CashFlowStatementDetailed({ 
  ...
  const defaultData: DetailedCashFlowData = {
    ...
    operatingActivities: {
      ...
      adjustments: {
        depreciation: 8000,
        amortization: 2500,
        lossOnSaleOfAssets: 1200,
        badDebtExpense: 800,
        stockBasedCompensation: 3500,
        deferredTaxes: -1500,
        totalAdjustments: 14500
      },
      workingCapitalChanges: {
        ...
        accruedLiabilities: 1200,
        deferredRevenue: 800,
        totalWorkingCapitalChanges: -4000
      },
      netOperatingCashFlow: 39750
    },
    investingActivities: {
      capitalExpenditures: {
        equipmentPurchases: -15000,
        buildingPurchases: -25000,
        vehiclePurchases: -8000,
        totalCapEx: -48000
      },
      assetSales: {
        equipmentSales: 2000,
        buildingSales: 5000,
        totalAssetSales: 7000
      },
      investments: {
        purchaseOfSecurities: -12000,
        saleOfSecurities: 8000,
        acquisitions: -15000,
        totalInvestments: -19000
      },
      netInvestingCashFlow: -60000
    },
    financingActivities: {
      equity: {
        stockIssuance: 15000,
        stockRepurchases: -5000,
        dividendPayments: -8000,
        totalEquity: 2000
      },
      debt: {
        loanProceeds: 25000,
    ...
    supplementalDisclosures: {
      ...
      taxesPaid: 9750,
      nonCashTransactions: {
        assetAcquisitionByDebt: 10000,
        stockIssuedForServices: 2500
      }
    },
    netChangeInCash: 6750,
    beginningCash: 15000,
    endingCash: 21750
  }
