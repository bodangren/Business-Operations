...
interface IncomeStatementSimpleProps {
...
export function IncomeStatementSimple({ 
  ...
  const LineItem = ({ label, amount, isSubtotal = false, isTotal = false, indent = false }: {
    label: string
    amount: number
    isSubtotal?: boolean
    isTotal?: boolean
    ...
    <div className={`flex justify-between items-center py-2 ${
      ...
      isSubtotal ? 'border-t border-gray-300 font-semibold' : ''
    } ${indent ? 'pl-4' : ''}`}>
      ...
      <CardContent className="space-y-1">
        <div className="bg-gray-50 p-4 rounded-lg">
          ...
          <div className="mt-4">
            ...
            <LineItem label="Income Before Taxes" amount={statementData.netIncomeBeforeTaxes} isSubtotal />
          </div>
