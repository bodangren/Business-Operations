...
export const spreadsheetTemplates = {
  tAccount: tAccountTemplate,
  trialBalance: trialBalanceTemplate,
  incomeStatement: incomeStatementTemplate,
  statisticalAnalysis: statisticalAnalysisTemplate,
  payroll: payrollTemplate,
  breakEven: breakEvenTemplate,
};
