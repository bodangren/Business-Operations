/**
 * PitchPresentationBuilder Component
 * 
 * DEVELOPER USAGE:
 * ================
...
const PITCH_SECTIONS: Record<PitchSection, { 
  name: string; 
...
export function PitchPresentationBuilder() {
  ...
  const getTotalTargetTime = useCallback(() => {
    return Object.values(PITCH_SECTIONS).reduce((sum, section) => sum + section.timeTarget, 0)
  }, [])
  ...
  const sectionInfo = PITCH_SECTIONS[pitchState.currentSection]
      ...
      <Card className="bg-gradient-to-r from-indigo-50 to-purple-50 border-indigo-200">
        <CardHeader className="text-center">
          ...
          <CardDescription className="text-lg">
            Build a compelling 4-minute investor pitch for your startup business model
          </CardDescription>
          <div className="mt-4">
            <Button
              variant="outline"
          ...
          <CardContent className="space-y-6">
            ...
            <div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                {Object.entries(PITCH_SECTIONS).map(([key, section]) => (
        ...
        <Card className="border-2 border-green-200 bg-green-50">
          ...
          <CardContent className="space-y-6">
            ...
            <div className="space-y-3">
              ...
              {Object.entries(PITCH_SECTIONS).map(([key, section], index) => {
                const startTime = Object.entries(PITCH_SECTIONS)
                  .slice(0, index)
                  ...
                  <div className="space-y-2">
                    {Object.entries(pitchState.sections).map(([key, section]) => (
                      <div key={key} className="flex items-center justify-between text-sm">
                        <span>{PITCH_SECTIONS[key as PitchSection].name}</span>
                        <div className="flex items-center gap-2">
