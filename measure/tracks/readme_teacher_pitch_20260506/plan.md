# Teacher-focused README pitch with screenshots

## Tasks
- [x] Audit current README and app surfaces for truthful teacher-facing claims.
- [x] Capture representative screenshots from multiple lessons/phases.
- [x] Replace the README with a teacher-focused online textbook pitch.
- [x] Verify links/assets and record completion status.
