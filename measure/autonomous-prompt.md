/measure
Step 1: Load Context. Read `measure/current_directive.md`, `measure/tech-debt.md`, `measure/lessons-learned.md`, `measure/tracks.md`.
...
- For each task: attach git notes per measure protocol, merge changes, and push.
