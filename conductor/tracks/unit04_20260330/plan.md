...
- [ ] 4.1 **Lesson 07** - Implement project-rehearsal skill
  ...
  - [ ] 4.1.3 Use one teacher dataset for the whole class
  - [ ] 4.1.4 Trace the recommendation back to the cleaned data and charts
  - [ ] 4.1.5 Include a clear audit or peer-review routine
  - **Done when**:
