...
3. **Populate teacher guidance fields**: 80 daily lessons have empty fields — deferred, see `conductor/tracks/defer_teacher_guidance_fields_20260408/future-work.md`
...
5. **Unit 7 conductor track**: Retrospectively document the starter workbook migration for planning consistency (low priority)
