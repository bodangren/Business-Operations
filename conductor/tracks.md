...
This file tracks active and archived Conductor tracks.

Legacy `Unitxx-Improvement-Plan.md` files have been consolidated into the Conductor track specifications and implementation plans. Treat the track directories below as the only active planning source.

---

## Active Tracks

- [ ] **Track: Reference system — bilingual glossary, index, and unit vocabulary lists** (in progress — Phase 1 complete) (in progress - Phase 1 complete)
