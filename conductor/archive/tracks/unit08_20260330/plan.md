...
- [x] 4.1 **Lesson 07** - Implement project-rehearsal skill
  ...
  - [x] 4.1.3 Use one shared fixed-asset dataset and one shared workbook for the whole class
  - [x] 4.1.4 Trace the final recommendation back to the asset register, schedule, and statement-impact evidence
  - [x] 4.1.5 Include a Definition of Done and peer-audit routine
  - [x] 4.1.6 Remove all startup-model and VC-pitch language from lesson content
  - **Done when**:
...
- [x] 4.2 **Lesson 08** - Implement group-project skill
  ...
  - [x] 4.2.2 Implement kickoff with group-specific fixed-asset data
  ...
  - [x] 4.2.3 Assign each group its own fixed-asset dataset or starter workbook
